...
test('browser report rejects changed measurement inputs and validation samples', () => {
  for (const mutate of [
    ...
    value => { value.fixture.manifestSha256 = 'changed'; },
    value => { value.runner.browser = 'firefox'; },
    value => { value.runner.headless = false; },
    value => { value.runner.node = '26'; },
    value => { value.runner.npmVersion = '12'; },
    value => { value.runner.playwright = '1.64'; },
    value => { value.runner.accessibilityInstrumentation = true; },
    value => { value.runner.monitorViewEvents = false; },
    value => { value.runner.runOrder = ['other']; },
    value => { value.runner.workloadTimeoutMilliseconds = 20000; },
    value => { value.runner.samples = 26; },
    value => { value.runner.warmups = 6; },
    value => { value.runner.host.cpuCount = 16; },
    value => { value.runner.host.totalMemoryBytes = 2000; },
    value => { value.runner.host.architecture = 'arm64'; },
    value => { value.runner.host.platform = 'darwin'; },
