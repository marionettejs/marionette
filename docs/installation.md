...
This guide describes rc.2. Registry commands require that version to be published;
...
| `marionette` `5.0.0-rc.2` | Required | The matching core runtime configured with an adapter. |
...
npm install @mnjs/adapters@5.0.0-rc.2 jquery

# Only if you use XState actors
npm install @mnjs/adapters@5.0.0-rc.2 xstate
```
...
```bash
npm install @mnjs/data@5.0.0-rc.2
```
...
```bash
npm install @mnjs/adapters@5.0.0-rc.2 morphdom
# or
npm install @mnjs/adapters@5.0.0-rc.2 lit-html
```
