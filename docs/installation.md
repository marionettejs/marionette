...
This guide describes beta.3. Registry commands require that version to be published;
...
```bash
npm install marionette@5.0.0-beta.3
```
...
| `marionette` `5.0.0-beta.3` | Required | The matching core runtime configured with an adapter. |
...
npm install @mnjs/adapters@5.0.0-beta.3 backbone

# Only if you use the jQuery DomApi adapter
npm install @mnjs/adapters@5.0.0-beta.3 jquery

# Only if you use XState actors
npm install @mnjs/adapters@5.0.0-beta.3 xstate
```
...
```bash
npm install @mnjs/data@5.0.0-beta.3
```
...
```bash
npm install @mnjs/adapters@5.0.0-beta.3 morphdom
# or
npm install @mnjs/adapters@5.0.0-beta.3 lit-html
```
