...
```sh
npm install marionette @mnjs/adapters backbone
```
...
```sh
npm install marionette @mnjs/adapters xstate
```
...
```sh
npm install marionette @mnjs/adapters jquery
```
...
```sh
npm install marionette @mnjs/adapters morphdom
```
...
```sh
npm install marionette @mnjs/adapters lit-html
```
