...
```sh
npm install marionette@5.0.0-beta.3 @mnjs/adapters@5.0.0-beta.3 backbone
```
...
```sh
npm install marionette@5.0.0-beta.3 @mnjs/adapters@5.0.0-beta.3 xstate
```
...
```sh
npm install marionette@5.0.0-beta.3 @mnjs/adapters@5.0.0-beta.3 jquery
```
...
```sh
npm install marionette@5.0.0-beta.3 @mnjs/adapters@5.0.0-beta.3 morphdom
```
...
```sh
npm install marionette@5.0.0-beta.3 @mnjs/adapters@5.0.0-beta.3 lit-html
```
