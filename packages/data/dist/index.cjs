...
Model.extend = marionette.extend;
assignOwn(Model.prototype, marionette.Events, {
  idAttribute: 'id',
  _isDestroyed: false,
  initialize() {},
  get(key) {
...
Collection.extend = marionette.extend;
assignOwn(Collection.prototype, marionette.Events, {
  model: Model,
  _isDestroyed: false,
  initialize() {},
  _prepareModel(item) {
  ...
  _restoreModelBinding(model) {
    marionette.Events.off.call(model, 'all', this._onModelEvent, this);
    marionette.Events.on.call(model, 'all', this._onModelEvent, this);
    addModelOwner(model, this, () => releaseOwnedModel(this, model));
  },
...
const triggerMethod = marionette.Events.triggerMethod;
